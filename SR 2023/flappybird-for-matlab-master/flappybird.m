...
FloorSpriteHdl = [];
ScoreInfoHdl = [];
ScoreInfoBackHdl = []; %Erin
ScoreInfoForeHdl = []; %Lee
GameOverHdl = [];
FloorAxesHdl = [];
%% Game Parameters
MainFigureInitPos = [];
...
%         Bird.Angle = double(mod(CurrentFrameNo,360))*pi/180;
    ...
    function initVariables()
        ...
        TUBE.H_SPACE = 125;  %100         % Horizontal spacing between two tubs
        TUBE.V_SPACE = 150;  %48         % Vertical spacing between two tubs - edit to make easier
